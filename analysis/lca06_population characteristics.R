...
source("preprocessing/lfpre06_population characteristics.R")
...
grouped_vars <- c("sex","age_category","age_category10","education",
                  "caste","religion","bmi_category")
# "wealthq_ur",

id_vars = c("residence",group_vars);
lasi_sy <- svysummary(lasipop_svydesign,
...
lasi_out %>% 
  write_csv(.,file = "analysis/lca06_population characteristics.csv")
