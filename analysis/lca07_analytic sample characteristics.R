...
source("preprocessing/lfpre03_lasi total svydesign.R")
...
lasi_sy <- svysummary(lasi_svydesign,
...
write_csv(lasi_out,file = "analysis/lca07_analytic sample characteristics.csv")
